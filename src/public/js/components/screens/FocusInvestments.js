    ...
    return React.createElement('article', {className: 'focus invest'},
        ...
        React.createElement('section', {},
            ...
            React.createElement(FocusDetail, {
                ...
                text: `Le Département investit dans des programmes en partenariat avec des acteurs privés en vue de déployer plus rapidement des infrastructures d'accès ou de services au ciotyens girondins.`,
                highlights: [
                    {
                        strong: "1 M€",
                        span: "de financement pour la construction des pôles solidarités"
                    },
                    {
                        strong: "9 M€",
                        span: "de financement pour le programme Gironde Haut débit"
                    },
                    {
                        strong: "8 M€",
                        span: "d'autres trucs"

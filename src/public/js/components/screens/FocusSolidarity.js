    ...
    return React.createElement('article', {className: 'focus'},
        ...
        React.createElement('section', {className: 'top-infos'}, 
            ...
            React.createElement('div', {}, 
                React.createElement(Markdown, {}, 
                    `**Avec 120 000 prestations allouées et ${currentYearSolidarity && (currentYearSolidarity.solidarityExpenditures/1000000).toFixed(0)} millions d'euros mobilisés en ${currentYear}, les dépenses de Solidarités pour soutenir les personnes fragilisées évoluent de +4,31% par rapport à 2015.**`),

...
export function FocusSol({
    ...
    return React.createElement('article', {className: 'focus'},
        ...
        React.createElement('section', {},
            ...
            React.createElement(Markdown, {}, `Les dépenses de solidarité concernent quatre catégories de bénéficiaires : les personnes en insertion ou en situation de précarité, les personnes handicapée, les personnes âgées, les enfants.

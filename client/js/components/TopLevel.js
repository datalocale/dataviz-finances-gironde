...
export default function(
  {
    ...
    selection,
    onM52NodeOvered,
    onAggregatedNodeOvered,
    onM52NodeSelected,
    onAggregatedNodeSelected,
    onRDFIChange,
    onAggregatedDFViewChange
  }
) {
  return M52Instruction
    ? React.createElement(
        'div',
        { className: 'top-level' },
        React.createElement(
          ...
          React.createElement(M52Viz, {
            ...
            M52HighlightedNodes,
            selectedNode: (
              selection && selection.type === M52_INSTRUCTION
                ? selection.node
                : undefined
            ),
          ...
          React.createElement(AggregatedViz, {
            ...
            aggregatedHighlightedNodes,
            selectedNode: (
              selection && selection.type === AGGREGATED_INSTRUCTION
                ? selection.node
                : undefined
            ),
            rdfi,
        ...
        selection
          ? React.createElement(TextualSelected, { selection })
          : undefined,

...
export function isRF(m52Row) {
  return m52Row['Dépense/Recette'] === 'R' &&
    m52Row['Investissement/Fonctionnement'] === 'F';
}
...
export function isRI(m52Row) {
  return m52Row['Dépense/Recette'] === 'R' &&
    m52Row['Investissement/Fonctionnement'] === 'I';
}
...
export const rules = Object.freeze({
  ...
  'RF-1-1': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRF(m52Row) &&
        ['A73111', 'A7318', 'A7875', 'A7788'].includes(m52Row['Article']);
    }
  },
  'RF-1-2': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRF(m52Row) &&
        ['A7311', 'A73112'].includes(m52Row['Article']);
    }
  },
  'RF-1-3': {
  ...
  'RF-3': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRF(m52Row) &&
        ['A7321', 'A7322', 'A7482'].includes(m52Row['Article']);
    }
  },
  'RF-4-1': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRF(m52Row) &&
        ['A7323', 'A7324', 'A7327'].includes(m52Row['Article']);
    }
  },
  'RF-4-2': {
  ...
  'RF-4-4': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRF(m52Row) &&
        ['A7362', 'A7353', 'A7388'].includes(m52Row['Article']);
    }
  },
  'RF-5-1': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRF(m52Row) &&
        ['A7411', 'A74122', 'A74123'].includes(m52Row['Article']);
    }
  },
  'RF-5-2': {
  ...
  'RF-5-3': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRF(m52Row) &&
        ['A74833', 'A74834', 'A74835'].includes(m52Row['Article']);
    }
  },
  'RF-5-4': {
  ...
  'RF-6-1': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRF(m52Row) &&
        ['A75342', 'A75343'].includes(m52Row['Article']);
    }
  },
  'RF-6-2': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRF(m52Row) &&
        ['A747811', 'A747812'].includes(m52Row['Article']);
    }
  },
  'RF-6-3': {
  ...
  'RF-6-4': {
    ...
    filter(m52Row) {
      ...
      const otherRecetteSocialeIds = Object.keys(rules).filter(
        id => id !== 'RF-6-4' && id.startsWith('RF-6')
      );

      return isOR(m52Row) &&
        isRF(m52Row) &&
        (fonction === '4' || fonction === '5') &&
        otherRecetteSocialeIds.every(id => !rules[id].filter(m52Row));
    }
  },
  'RF-7-1': {
  ...
  'RF-8-1': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRF(m52Row) &&
        ['A7326', 'A73261', 'A73262'].includes(m52Row['Article']);
    }
  },
  'RF-8-2': {
  ...
  'RF-9-6': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRF(m52Row) &&
        ['A6419', 'A6459', 'A6479'].includes(m52Row['Article']);
    }
  },
  'RF-9-7': {
  ...
  'DF-1-1-1': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isDF(m52Row) &&
        ['A652221', 'A65242'].includes(m52Row['Article']);
    }
  },
  'DF-1-1-2': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isDF(m52Row) &&
        ['A652224', 'A65243'].includes(m52Row['Article']);
    }
  },
  'DF-1-1-3': {
  ...
  'DF-1-2': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isDF(m52Row) &&
        ['A6515', 'A65171', 'A65172'].includes(m52Row['Article']);
    }
  },
  'DF-1-3': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isDF(m52Row) &&
        ['A6511211', 'A6511212', 'A651128', 'A651122'].includes(
          m52Row['Article']
        );
    }
  },
  'DF-1-4': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isDF(m52Row) &&
        ['A651141', 'A651142', 'A651143', 'A651144', 'A651148'].includes(
          m52Row['Article']
        );
    }
  },
  ...
  'DF-1-7-2': {
    ...
    filter(m52Row) {
      ...
      const art = m52Row['Article'];
      const f2 = fonction.slice(0, 2);
      const parPrestationRuleIds = Object.keys(rules).filter(
        id => id.startsWith('DF-1-') && id !== 'DF-1-7-2'
      );
      ...
      return isOR(m52Row) &&
        ...
        (art.startsWith('A60') ||
          ...
          art.startsWith('A65') ||
          art.startsWith('A67')) &&
        parPrestationRuleIds.every(id => !rules[id].filter(m52Row)) &&
        !(art === 'A6526' && (fonction === 'R58' || fonction === 'R51'));
    }
  },
  'DF-2-1': {
  ...
  'DF-3-3': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isDF(m52Row) &&
        ['A6526', 'A6563'].includes(m52Row['Article']);
    }
  },
  'DF-3-4': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isDF(m52Row) &&
        ['A65511', 'A65512'].includes(m52Row['Article']);
    }
  },
  'DF-3-5': {
    ...
    filter(m52Row) {
      ...
      return isOR(m52Row) &&
        isDF(m52Row) &&
        f3 === 'R72' &&
        ['A6556', 'A65561'].includes(m52Row['Article']);
    }
  },
  'DF-3-6': {
  ...
  'RI-3': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRI(m52Row) &&
        (m52Row['Article'] === 'A1341' || m52Row['Article'] === 'A10221');
    }
  },
  'RI-4': {
    label: 'Subventions',
  ...
  'RI-6': {
    ...
    filter(m52Row) {
      ...
      return isOR(m52Row) &&
        isRI(m52Row) &&
        article !== 'A204' &&
        (['A165', 'A1676', 'A454121', 'A454421', 'A454428', 'A45821'].includes(
          article
        ) ||
          ['C20', 'C21', 'C22', 'C23', 'C26', 'C27'].includes(
            m52Row['Chapitre']
          ));
    }
  },
  ...
  'RI-EM-1': {
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRI(m52Row) &&
        ['A1641', 'A16311', 'A167', 'A168'].includes(m52Row['Article']);
    }
  },
  'RI-EM-2': {
    label: 'OCLT',
    ...
    filter(m52Row) {
      return isOR(m52Row) &&
        isRI(m52Row) &&
        ['A16441', 'A16449'].includes(m52Row['Article']);
    }
  },
  /**
  ...
  'DI-EM-1': {
    ...
    filter(m52Row) {
      ...
      return isOR(m52Row) &&
        isDI(m52Row) &&
        ['A1641', 'A16311', 'A167', 'A168'].includes(article);
    }
  },
  'DI-EM-2': {
    ...
    filter(m52Row) {
      ...
      return isOR(m52Row) &&
        isDI(m52Row) &&
        ['A16441', 'A16449'].includes(article);
    }
  }
});
...
export default function convert(m52Instruction) {
  return ImmutableSet(
    Object.keys(rules).map(id =>
      makeAggregatedInstructionRowRecord(id, m52Instruction))
  );
}

...
export const rules = Object.freeze({
    ...
    'RF-1-1' : {
        ...
        filter(m52Row){
            return isRF(m52Row) && ['A73111', 'A7318', 'A7875', 'A7788'].includes(m52Row['Article']);
        }
    },
    'RF-1-2' :{
        ...
        status: 'TEMPORARY',
        filter(m52Row){
            return isRF(m52Row) && ['A7311', 'A73112'].includes(m52Row['Article']);
        }
    },
    'RF-1-3': {
    ...
    'RF-2-1': {
        ...
        filter(m52Row){
            return isRF(m52Row) && 'A7352' === m52Row['Article'];
        }
    },
    'RF-2-2': {
    ...
    'RF-4-1': {
        ...
        filter(m52Row){
            return isRF(m52Row) && ['A7323', 'A7324', 'A7327'].includes(m52Row['Article']);
        }
    },
    'RF-4-2': {
    ...
    'RF-5-1': {
        ...
        filter(m52Row){
            return isRF(m52Row) && ['7411', '74122', '74123'].includes(m52Row['Article']);
        }
    },
    'RF-5-2': {
        label: "Dotation Globale de Décentralisation (DGD)",
        filter(m52Row){
            return isRF(m52Row) && 'A7461' === m52Row['Article'];
        }
    },
    'RF-5-3': {
    ...
    'RF-5-4': {
        ...
        filter(m52Row){
            return isRF(m52Row) && 'A74832' === m52Row['Article'];
        }
    },
    'RF-5-5': {
        label: "Fonds National de Garantie Individuelle de Ressources (FNGIR)",
        filter(m52Row){
            return isRF(m52Row) && 'A73121' === m52Row['Article'];
        }
    },
    'RF-6-1': {
        label: "Indus RSA",
    ...
    'RF-8-1': {
        ...
        filter(m52Row){
            return isRF(m52Row) && ['A7326', 'A73261', 'A73262'].includes(m52Row['Article']); 
        }
    },    
    'RF-8-2': {
        label: "Fonds exceptionnel pour les départements en difficulté",
        filter(m52Row){
            return isRF(m52Row) && m52Row['Article'] === 'A74718';
        }
    },
    'RF-9-1': {
    ...
    /**
     * NUMEROTATION CHELOU DANS LE FICHIER.
     * CA SAUTE DE 9-1 à 9-3    
     * JE PRENDS l'INITIATIVE DE RENOMMER EN 9-2 ET LES SUIVANTS
     */
    ...
    'DF-1-5-1': {
        ...
        status: 'TEMPORARY',
        filter(m52Row){
            return isDF(m52Row) && ['A652416', 'A6514', 'A65111', 'A6718'].includes(m52Row['Article']);
        }
    },
    'DF-1-5-2': {
    ...
    'DF-2-1': {
        ...
        filter(m52Row){
            ...
            return isDF(m52Row) && (f3 === 'R54' || f3 === 'R56');
        }
    },
    'DF-2-2': {
    ...
    'DF-2-3': {
        ...
        filter(m52Row){
            const fonction = m52Row['Rubrique fonctionnelle'];
            const f3 = fonction.slice(0, 3);
            return isDF(m52Row) && (f3 === 'R55' || f3 === 'R53');
        }
    },
    'DF-2-4': {
        label: "Enfance",
    ...
    'DF-2-5': {
        ...
        filter(m52Row){
            ...
            return isDF(m52Row) && ['R58', 'R50', 'R40', 'R41', 'R42', 'R48'].includes(f3);
        }
    },
    ...
    'DF-3-5': {
        ...
        filter(m52Row){// de la fonction 72
            ...
            return isDF(m52Row) && f3 === 'R72' && ['A6556', 'A65561'].includes(m52Row['Article']);
        }
    },
    'DF-3-6': {
    ...
    'DF-5-1': { 
        ...
        filter(m52Row){
            ...
            return isDF(m52Row) && (art === 'A73914' || art === 'A73926');
        }
    },
    'DF-6-1': { 
        label: "FAJ",
        status: 'TEMPORARY',
        filter(m52Row){
            return isDF(m52Row) && m52Row['Article'] === 'A65562';
        }
    },
    'DF-6-2': { 
    ...
    'DF-6-3': { 
        label: "Questure",
        filter(m52Row){
            return isDF(m52Row) && ['A65861', 'A65862'].includes(m52Row['Article']);
        }
    },
    'DF-6-4': { 
    ...
    'RI-5': {
        ...
        filter(m52Row){
            ...
            return isRI(m52Row) && (article === 'A1335' || article === 'A1345')
        }
    },
    'RI-6': {
        label: "RI - Divers",
    ...
    'RI-EM-1': {
        ...
        status: 'TEMPORARY',
        filter(m52Row){
            return isRI(m52Row) && ["A1641", "A16311", "A167", "A168"].includes(m52Row['Article']);
        }
    },
    'RI-EM-2': {
        label: "OCLT",
        status: 'TEMPORARY',
        filter(m52Row){
            return isRI(m52Row) && ["A16441", "A16449"].includes(m52Row['Article']);
        }
    },
    ...
    'DI-EM-1': {
        ...
        filter(m52Row){
            ...
            return isDI(m52Row) && ["A1641", "A16311", "A167", "A168"].includes(article);
        }
    },
    'DI-EM-2': {
        ...
        filter(m52Row){
            ...
            return isDI(m52Row) && ["A16441", "A16449"].includes(article);
        }
    }
});
